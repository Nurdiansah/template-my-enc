...
use App\Models\BussinessUnitsModel;
...
$BuModel = new BussinessUnitsModel();
...
if ($user_info['user_type'] == 'staff') {
  $bus = $BuModel->orderBy('bu_name', 'ASC')->findAll();
          ...
          <div class="card mb-2">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="bussiness_unit">
                      <!-- <= lang('Dashboard.left_department'); ?> -->
                      Bussiness Unit
                    </label>
                    <span class="text-danger">*</span>
                    <select class="form-control" name="bu_id" id="bu_id" data-plugin="select_hrm" data-placeholder="Bussiness Unit">
                      <option value="">
                        <!-- <?= lang('Dashboard.left_bussinessunit'); ?> -->
                        Bussiness Unit
                      </option>
              ...
              <div class="row">
                ...
                <input type="hidden" class="form-control" name="hourly_rate" placeholder="<?= lang('Employees.xin_hourly_rate'); ?>" value="0">
                <!-- </div>
                  </div>
                </div> -->
                <div class="col-sm-6">
